...
const RembrandtProjectPage = lazy(
  () => import("./components/RembrandtProjectPage"),
);
const ItemDetailPage = lazy(() => import("./components/ItemDetailPage"));
const PrivacyPage = lazy(() => import("./components/PrivacyPage"));
const TermsPage = lazy(() => import("./components/TermsPage"));
const MobileItemDetailPage = lazy(
...
export default function App() {
  ...
  const handleNavigate = (targetId) => {
    const returningDetailItemId =
      currentPage === "item-detail" ? selectedDetailItemId : null;
  ...
  const handleSaveItem = async (itemToSave) => {
    ...
    if (res && res.success !== false) {
      setCatalog((currentCatalog) => {
        const index = currentCatalog.findIndex(
  ...
  const handleDeleteItem = async (idToDelete) => {
    ...
    if (res && res.success !== false) {
      setCatalog((currentCatalog) =>
        currentCatalog.filter((item) => item.id !== idToDelete),
      );
    }
    return res;
  };
  ...
  useEffect(() => {
    const selectedItem = catalog.find((item) =>
      itemMatchesRoute(item, selectedDetailItemId),
    );
    ...
    return (
      ...
      >
        <AdminDashboard
          ...
          onRembrandtProjectPublished={setRembrandtProjectData}
    ...
    <div className="min-h-screen bg-transparent text-[#111111] flex flex-col font-sans selection:bg-[#111111]/10 selection:text-[#111111]">
      ...
      <main className="flex-grow">
        <Suspense
          fallback={
            <div
              className="min-h-[70vh] bg-[#FFFEFC]"
        ...
        >
          {currentPage === "item-detail" ? (
            ...
            isMobile ? (
              <MobileItemDetailPage
                ...
                onRequestInquiry={(item) =>
                  handleOpenConsultation(item, "purchase", "mobile_item_detail")
                }
              />
            ) : (
              <ItemDetailPage
                ...
                onNavigateBack={() => handleNavigate("catalogus")}
                onRequestInquiry={(item) =>
                  handleOpenConsultation(item, "purchase", "item_detail")
                }
              />
            )
            ...
            <HerkomstPage
              ...
              onNavigateHome={() => handleNavigate("home")}
              onRequestConsultation={() =>
                handleOpenConsultation(null, "general_query", "provenance")
              }
            />
            ...
            <PrivacyPage
              onNavigateHome={() => handleNavigate("home")}
              onRequestConsultation={() =>
                handleOpenConsultation(null, "general_query", "privacy")
              }
            />
            ...
            <TermsPage
              onNavigateHome={() => handleNavigate("home")}
              onRequestConsultation={() =>
                handleOpenConsultation(null, "general_query", "terms")
              }
            />
          ) : currentPage === "not-found" ? (
            <section className="mx-auto flex min-h-[70vh] max-w-2xl flex-col items-center justify-center px-6 pt-28 text-center">
              <p className="mb-3 font-mono text-xs uppercase tracking-[0.24em] text-[#8A6A25]">
                404
              </p>
              <h1 className="font-serif text-4xl font-bold text-[#111111] sm:text-5xl">
            ...
            <>
              ...
              {isMobile ? (
                <MobileHero
                  ...
                  onRequestConsultation={() =>
                    handleOpenConsultation(null, "general_query", "mobile_hero")
                  }
                />
              ) : (
                <Hero
                  ...
                  onExploreCatalog={() => handleNavigate("catalogus")}
                  onRequestConsultation={() =>
                    handleOpenConsultation(null, "general_query", "hero")
                  }
                />
              )}
              ...
              {isMobile ? (
                <MobileHomeSections
                  ...
                  onRequestConsultation={() =>
                    handleOpenConsultation(null, "general_query", "mobile_home")
                  }
                />
              ) : (
                <>
                  ...
                  <FaqSection
                    items={faqItems}
                    onRequestConsultation={() =>
                      handleOpenConsultation(null, "general_query", "faq")
                    }
                  />
                </>
              )}
