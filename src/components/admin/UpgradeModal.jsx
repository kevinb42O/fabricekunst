...
const UpgradeModal = ({ isOpen, onClose, product = 'pro' }) => {
  ...
  const proDesc = isYearly ? '€20 / maand, gefactureerd als €240 per jaar. (Incl. 150 kunstwerken limiet)' : '€25 / maand, maandelijks gefactureerd. (Incl. 150 kunstwerken limiet)';
