...
import { Building2, CalendarDays, ExternalLink, Gavel } from 'lucide-react';
      ...
      <div className={`border-t border-[#D8CEB8]/70 pt-4 ${compact ? 'space-y-5' : 'space-y-8'}`}>
        {visibleSales.map((sale) => {
          ...
          return (
            ...
            >
              <div className={`bg-[#F4F1EA] ${compact ? 'min-h-52' : 'min-h-64'}`}>
                <img
                  src={sale.imageUrl}
              ...
              <div className={`flex flex-col justify-between ${compact ? 'p-4 sm:p-5' : 'p-5 sm:p-7'}`}>
