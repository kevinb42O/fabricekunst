      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full z-0 overflow-hidden pointer-events-none">
          ...
          <motion.div style={{ y: bgY }} className="w-full h-full absolute inset-0">
            <img
              ...
              alt="Fabrice Antiquariaat Herkomst & Expertise"
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full my-auto">
          ...
          >
            ...
            >
              Ontdek het rigoureuze protocol achter onze antiquarische selectie. Elk werk in de collectie van Fabrice beschikt over een gecertificeerde eigendomsgeschiedenis en geverifieerde staat.
            </motion.p>
      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 w-full h-full z-0 overflow-hidden pointer-events-none">
          <img
            ...
            alt="Fabrice Antiquariaat Sfeerachtergrond"
              ...
              <div className="bg-[#1C1A17] text-[#FAF7F2] rounded-2xl p-8 sm:p-14 border border-[#B8860B]/50 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-10">
                <div className="space-y-4 text-center lg:text-left max-w-2xl">
                  ...
                  <p className="text-sm sm:text-base text-[#C5BBAA] font-serif font-light leading-relaxed">
                    Fabrice adviseert verzamelaars en erfgenamen bij de waardebepaling, conservering en authenticiteitsverificatie van historische privé-bibliotheken.
                  </p>
                </div>
