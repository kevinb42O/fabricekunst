      ...
      >
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between border-b border-[#2A2620] pb-8 gap-6">
          ...
          <p className="text-[#C5BBAA] font-serif font-light text-base sm:text-lg max-w-xl leading-relaxed lg:pb-1">
            Elk stuk in de collectie van Fabrice wordt geselecteerd op basis van drie onberispelijke criteria: historische zeldzaamheid, esthetische staat van de band, en een aantoonbare herkomst.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            >
              ...
              <p className="text-sm text-[#C5BBAA] font-serif font-light leading-relaxed">
                Of u nu een particuliere bibliofiel bent of een institutionele verzameling uitbouwt: Fabrice biedt persoonlijk advies bij aankoop, conservering en waardebepaling.
              </p>
            </motion.div>
            ...
            <div className="pt-6">
              ...
              >
                <span>Plan een Privé-Bezichtiging met Fabrice</span>
