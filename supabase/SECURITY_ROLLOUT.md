...
1. Create these two users in Supabase Authentication with email confirmed:
...
4. Verify both Auth logins, then run
...
5. Verify both logins, catalog changes, inquiry management, image uploads,
